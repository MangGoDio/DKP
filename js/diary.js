...
end: ['阿何','麦兜','黑锋','吊爷','猫粮','西法','蝌蚪王','大S','小峰','满爷','马静','今晚'
,'大T','火歌','奥特曼','血魔','一建','6BB','滑稽','前卫','风哥'
...
kill: [
  ...
  },
  {
    name: '塞纳留斯',
    dif: 'H',
    ren: ['阿何','麦兜','黑锋','吊爷','猫粮','西法','蝌蚪王','大S','小峰','满爷','马静','今晚'
    ,'大T','火歌','奥特曼','血魔','一建','6BB','滑稽','前卫','风哥'
    ,'言水','小黑','蘑菇','小七','奇迹','老严','大H','喵星人'],
    equip: [
      {
...
id: 5,
date: '2016.10.20',
begin: ['阿何','黑锋','火空','吊爷','麦兜','悟饭','西法','小峰','大H','速度灭'
,'今晚','马静','老严','火歌','大T','小虾','奇迹','小黑','樱井','言水'
,'破魂','6BB','小七','奥特曼','一建','满爷','血魔','猫粮','蝌蚪王','蘑菇','风哥'],
off: [], // 请假分 10
end: ['阿何','黑锋','火空','吊爷','麦兜','悟饭','西法','小峰','大H','速度灭'
,'今晚','马静','老严','火歌','大T','小虾','奇迹','小黑','樱井','言水','老圈'
,'破魂','6BB','小七','奥特曼','一建','满爷','血魔','猫粮','蝌蚪王','蘑菇','风哥'],
add: [
  {
    name: '火空',
...
kill: [
  ...
  },
  {
    ...
    ren: ['阿何','吊爷','西法','火歌','小灵','大洪','麦兜','火空','星坠','老圈'
    ,'悟饭','速度灭','满爷','马静','风哥','破魂','奥特曼','大T','雷霆','血魔','大H'
    ,'凯壮','一建','大M','小黑','喵星人','前卫','小鸡','河蟹','小虾','滑稽'],
    equip: [
      {
        name: '皮甲胸',
        point: 30,
...
id: 7,
date: '2016.11.5',
begin: ['阿何','小黑','大H','吊爷','满爷','蘑菇','滑稽','大S','麦兜','老圈'
,'大T','雷霆','一建','小灵','言水','前卫','星坠','喵星人','血魔','火空','6BB','火歌'],
off: [], // 请假分 10
end: ['阿何','小黑','大H','吊爷','满爷','蘑菇','滑稽','大S','麦兜','老圈'
,'大T','一建','小灵','言水','前卫','星坠','喵星人','血魔','火空','6BB','火歌'
,'悟饭','樱井','大洪','小七','西法'],
add: [],
reduce: [],
kill: [
  {
    name: '尼珊德拉',
    dif: 'H',
    ren: ['阿何','小黑','大H','吊爷','满爷','蘑菇','滑稽','大S','麦兜','老圈'
    ,'大T','一建','小灵','言水','前卫','星坠','喵星人','血魔','火空','6BB','火歌'
  ,'老严','悟饭','樱井'],
    equip: [
      {
...
id: 8,
date: '2016.11.10',
begin: ['阿何','火歌','乌鸦','风哥','奇迹','猫粮','喵星人','大T','满爷','蘑菇','滑稽'
,'血魔','大S','小黑'],
off: ['老圈'], // 请假分 10
end: ['阿何','火歌','风哥','奇迹','猫粮','满爷','滑稽'
,'血魔','大S','小黑','大H','吊爷','雷霆','西法','老圈','前卫'],
add: [
  {
    name: '老杨',
    point: 50,
...
kill: [
  {
    name: '奥丁',
    dif: 'PT',
    ren: ['阿何','火歌','乌鸦','风哥','奇迹','猫粮','喵星人','大T','满爷','蘑菇','滑稽'
    ,'血魔','大S','小黑','大H','吊爷','马静','雷霆','西法','6BB','老杨','大洪'],
    equip: []
  },
  {
    name: '高姆',
    dif: 'PT',
    ren: ['阿何','火歌','乌鸦','风哥','奇迹','猫粮','喵星人','大T','满爷','蘑菇','滑稽'
    ,'血魔','大S','小黑','大H','吊爷','马静','雷霆','西法','6BB','老杨','大洪','老圈'],
    equip: []
  },
  {
    name: '海拉',
    dif: 'PT',
    ren: ['阿何','火歌','风哥','奇迹','猫粮','满爷','滑稽'
    ,'血魔','大S','小黑','大H','吊爷','雷霆','西法','老圈','前卫'],
    equip: []
  }
]
...
id: 8,
date: '2016.11.12',
begin: ['阿何','老严','奇迹','大T','大H','小灵','滑稽','火空','吊爷','大M'
,'西法','神魔','满爷','猫粮','星坠','大洪','蘑菇','破魂','老圈','小黑'
,'风哥','悟饭','马静'],
off: [], // 请假分 10
end:  ['阿何','老严','奇迹','大T','大H','小灵','滑稽','火空','吊爷','大M'
,'西法','神魔','满爷','猫粮','星坠','大洪','蘑菇','破魂','老圈','小黑'
,'风哥','悟饭','马静','前卫','老杨','樱井','大S','一建','火歌'],
add: [],
reduce: [],
kill: [
  {
    name: '尼珊德拉',
    dif: 'H',
    ren: ['阿何','老严','奇迹','大T','大H','小灵','滑稽','火空','吊爷','大M'
    ,'西法','神魔','满爷','猫粮','星坠','大洪','蘑菇','破魂','老圈','小黑'
    ,'风哥','悟饭','马静','前卫','黑锋','老杨','樱井','大S','一建'],
    equip: [
      {
        name: '布甲肩',
        point: 0,
...
var _gays = [
  ...
  {id: 61,nick: '乌鸦',name: '伊万麦列霍夫',pro: '猎人'},
  ...
  {id: 30,nick: '悟饭',name: '小葡萄钥钥',pro: '萨满'},
  ...
  {id: 29,nick: '老杨',name: 'Aaaaaaa',pro: '死亡骑士'},
