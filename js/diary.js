var _act = [
  ...
  },
  {
    ...
    add: [
      ...
      { name: "阿何", point: 30, mes: "全勤分" },
      { name: "吊爷", point: 30, mes: "全勤分" },
      { name: "麦兜", point: 30, mes: "全勤分" },
      { name: "西法", point: 30, mes: "全勤分" },
      { name: "奇迹", point: 30, mes: "全勤分" },
      { name: "蝌蚪王", point: 30, mes: "全勤分" },
      { name: "猫粮", point: 30, mes: "全勤分" },
      { name: "风哥", point: 30, mes: "全勤分" },
      { name: "满爷", point: 30, mes: "全勤分" },
      { name: "火歌", point: 30, mes: "全勤分" },
      { name: "伤心", point: 30, mes: "全勤分" },
      { name: "血魔", point: 30, mes: "全勤分" },
      { name: "樱井", point: 30, mes: "全勤分" },
      { name: "Des", point: 30, mes: "全勤分" },
      { name: "言水", point: 30, mes: "全勤分" },
      { name: "滑稽", point: 30, mes: "全勤分" }
    ],
    reduce: [
      {
        name: "小灵",
